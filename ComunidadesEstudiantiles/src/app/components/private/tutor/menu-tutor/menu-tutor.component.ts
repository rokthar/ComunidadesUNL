...
export class MenuTutorComponent implements OnInit {
                ...
                items: [
                    {
                        ...
                        icon: 'pi pi-eye',
                        command: () => this.links('postulaciones')
                    }
                ]
            },
            {
                ...
                items: [
                    {
                        ...
                        command: () => this.links('planificacion')
                    },
                    {
                        label: 'Generar Resultados',
                        icon: 'pi pi-book',
                        command: () => this.links('resultados')
                    }
                ]
            },
            {
                ...
                items: [
                    {
                        label: 'Solicitudes',
                        icon: 'pi pi-file',
                        command: () => this.links('vinculaciones')
                    },
                    {
                        label: 'Vincularse',
                        icon: 'pi pi-users',
                        command: () => this.links('vincularse')
                    }
                ]
            },
            {
                ...
                items: [
                    {
                        label: 'Actividades',
                        icon: 'pi pi-file-o',
                        command: () => this.generarReporteActividades()
                    },
                    {
                        label: 'Historial',
                        icon: 'pi pi-file-o',
                        command: () => this.generarReporteHistorial()
                    }
                ]
            },
            {
    ...
    generarReporteHistorial() {
        const values = {
            ...
            "asunto": "ejemplo de correo desde Angular",
            "mensaje": "Esto es un ejemplo de mensaje desde Angular"
        }
        this.usuario_service.enviarMail(values).subscribe((resp: any) => {
